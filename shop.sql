...
-- game_cds -------------------------------------------------------;
    ...
    ("GC05","PS5-Assassins Creed Valhalla",152.25),
    ...
    ("GC10","PS5-Ghost Of Tsushima Directors Cut",305.0),
    ("GC11","PS5-Tom Clancys Rainbow Six Siege Deluxe Edition",98.41),
    ...
    ("GC29","PS4-Tom Clancys Ghost Recon Breakpoint",35.0),
    ...
    ("GC36","PS4-Uncharted: Thiefs End",38.00),
    ("GC37","PS4-Tom Clancys The Division 2",48.41),
    ...
    ("GC45","PS4-Marvels Avengers",101.66),
    ...
    ("GC56","XBOX-Assassins Creed Valhalla",98.05),
    ("GC57","XBOX-The Dark Pictures: Little Hopes",84.78),
    ("GC58","XBOX-NBA 2K21",49.99),
    ("GC59","XBOX-Crash Bandicoot 4 Its About Time",205.88),
    ("GC60","XBOX-Cyberpunk 2077",138.0),
    ("GC61","XBOX-Outriders",137.33),
    ("GC62","Nintendo Switch-Super Smash Bros Ultimate",187.61),
    ...
    ("GC69","Nintendo Switch-Crash Bandicoot 4 Its About Time",186.45),
