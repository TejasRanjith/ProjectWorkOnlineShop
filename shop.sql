...
-- snacks ---------------------------------------------------------;
    ...
    ("SN01","Lays Chilli Chips 170g",6.55),
    ("SN02","Lays Salted Chips 23g",2.55),
    ("SN03","Lays Tomato Ketchup Chips",2.95),
    ("SN04","Lays Forno Black Pepper 170g",6.80),
    ("SN05","Lays Max Mexican Chilli Chips 200g",7.25),
    ...
    ("SN20","Pringles Sizzln Spicy BBQ Chips 160g",10.66),
    ("SN21","Pringles Sour Cream & Original Chips 200g",8.50),
    ("SN22","Pringles Sizzln Sour Cream & Onion Chips 160g",10.77),
...
-- phones ---------------------------------------------------------;
    ...
    ("PH07","Samsung Galaxy Z Fold 3 5G",7199.0),
    ("PH08","Samsung Galaxy Z Fold 2",4999.0),
    ("PH09","Samsung Galaxy Z Fold",4775.0),
    ("PH10","Samsung Galaxy Z Flip",3275.0),
    ("PH11","Samsung Galaxy Z Flip 3 5G",3799.0),
    ("PH12","Samsung Galaxy S21 Ultra",4999.0),
    ("PH13","Samsung Galaxy S21+",3599.0),
    ("PH14","Samsung Galaxy S21",3200.0),
    ("PH15","Samsung Galaxy S20 Ultra",3599.0),
    ("PH16","Samsung Galaxy S20",2699.0),
    ("PH17","Samsung Galaxy Note 20 Ultra",3599.0),
    ("PH18","Samsung Galaxy Note 20",3199.0),
    ("PH19","Samsung Galaxy S20 FE 5G",1829.55),
    ("PH20","Samsung Galaxy Note 10 Plus",2038.0),
    ("PH21","Samsung Galaxy Note 10",2649.0),
    ("PH22","Samsung Galaxy A32",999.0),
    ("PH23","Samsung Galaxy A22 LTE",669),
    ("PH24","Samsung Galaxy A12",597.0),
    ("PH25","Samsung Galaxy A02",411.0),
    ("PH26","Samsung Galaxy M12 LTE",529.0),
    ("PH27","OnePlus 9 Pro",3500.0),
    ("PH28","OnePlus 9",2500.0),
    ("PH29","OnePlus 8 Pro",2365.0),
    ("PH30","OnePlus 8t",2399.0),
    ("PH31","OnePlus 8",1450.0),
    ("PH32","OnePlus Nord CE 5G",1290.0),
    ("PH33","OnePlus Nord N100",499.0),
    ("PH34","Huawei Mate 40 Pro 5G",3749.0),
    ("PH35","Huawei Nova 7 SE",1259.0),
    ("PH36","Huawei P40 Lite",799.0),
    ("PH37","Huawei Nova 7i",797.0),
    ("PH38","Huawei Y7a",655.54),
    ("PH39","Xiaomi Mi 10",3099.0),
    ("PH40","Xiaomi Poco X3 Pro",1120.0),
    ("PH41","Xiaomi Poco X3 GT",1197.0),
    ("PH42","Xiaomi Poco X3 LTE",1099.0),
    ("PH43","Xiaomi Redmi 9A",326.29),
    ("PH44","Oppo Reno5 Pro 5G",2339.0),
    ("PH45","Oppo Reno5 Z 5G",1299.00),
    ("PH46","Oppo A94",1242.0),
    ("PH47","Oppo A73 5G",1100.0),
    ("PH48","Oppo A54",559.0),
    ("PH49","Oppo Reno 5G",1699.0),
    ("PH50","Samsung A22 LTE",849.0),
    ("PH51","Lenovo Legion",1799.0),
    ("PH52","Sony Xperia XA1 4G",279.0),
    ("PH53","Nokia X20 5G",1128.60),
    ("PH54","Nokia 8 5G",1039.0),
    ("PH55","Nokia X10",930.0),
    ("PH56","Nokia C10",285.0),
    ("PH57","Realme 8 5G",795.0),
    ("PH58","Asus ROG Phone 5",2779.0),
...
-- tvs ------------------------------------------------------------;
    ...
    ("TV18","Samsung 65 inch TU7000 UHD 4K Flat TV",2799.0),
    ("TV19","Samsung 85 inch Q70A QLED 4K Smat TV",9850.0),
    ("TV20","Samsung 85 inch TU8000 Crytal UHD 4K Flat Smart TV",7183.0),
    ("TV21","Samsung 60 inch AU8000 Crystal UHD 4K Flat Smart TV",2759.0),
    ("TV22","Samsung 75 inch AU7000 Crytal UHD 4K Flat Smart TV",4500.0),
    ("TV23","Samsung 55 inch Q70A QLED 4K Smart TV",3345.64),
    ("TV24","Hisense 55 inch A6GE UHD Smart TV",1699.0),
    ("TV25","Hisense 50 inch A6GE UHD Smart TV",1570.0),
    ("TV26","Hisense 58 inch 58A7100F UHD 4K Smart TV",1715.0),
    ("TV27","LG 55 inch UP77 UHD 4K Smart TV",2439.92),
    ("TV28","LG 65 inch UP77 UHD 4K Smart TV",3004.70),
    ("TV29","Sony 55 inch Bravia XR OLED Smart TV",5999.0),
    ("TV30","Sony 85 inch X9000H UHD 4K Smart TV",9214.50),
    ("TV31","Sony 65 inch Bravia X80AJ UHD 4K Smart Google TV",3699.0),
    ("TV32","TCL 65 inch QLED UHD TV",6401.03),
    ("TV33","Panasonic 65 inch 4K HDR UHD Smart TV",2799.0),
    ("TV34","Samsung 75 inch AU9000 Crystal UHD 4K Flat Smart TV",6699.0);
...
-- milk -----------------------------------------------------------;
    ...
    ("MI40","Baskin Robins Oreo Cookiesn Cream 1Kg",35.65),
    ...
    ("MI56","Nambisans Pure Ghee Jar 200ml",10.45),
    ("MI57","Nambisans Pure Ghee Jar 1L",41.95),
...
-- bathroom_items -------------------------------------------------;
    ...
    ("BI99","Johnsons Anti-Bacterial Hand Wash Pack(2) 300ml",17.29),
    ("BI100","Johnsons Anti-Bacterial Micellar Mint Hand Wash 300ml",12.65),
    ("BI101","Jennifers Anti-Bacterial Hand Wash Pack(3) 500ml",15.44),
    ...
    ("BI120","Clear Mens Cool Sport Menthol Shampoo Pack(2) 400ml",19.25),
    ("BI121","LOreal Paris Elvive Total Repair Shampoo 400ml",20.95),
...
-- chocolate ------------------------------------------------------;
    ...
    ("CH04","Hersheys Kisses Classic Milk Chocolate 226g",20.68),
    ("CH05","Hersheys Chocolate Syrup 650g",13.95),
    ("CH06","Hersheys Cocoa Creations Original Chocolate 100g",9.56),
    ...
    ("CH12","Mackintoshs Quality Street Chocolate 850g",43.15),
    ("CH13","Mackintoshs Quality Street Chocolate 375g",27.90),
...
-- stationaries ---------------------------------------------------;
    ...
    ("ST94","Elmers Clear Washable Liquid Glue",27.75),
...
-- story_book -----------------------------------------------------;
    ...
    ("SB01","Harry Potter And The Philosofers Stone Book",29.99),
    ...
    ("SB11","Percy Jackson And The Olympians Book 3 The Titans Curse",32.51),
    ...
    ("SB38","Roald Dahl Georges Marvellous Medicine",25.13),
...
-- gaming_console -------------------------------------------------;
    ...
    ("GC01","Sony Playstation 5 Console Standard Edition White",3030.00),
    ("GC02","Sony Playstation 5 Console Standard Edition Black",3030.00),
    ("GC03","Sony Playstation 4 Slim 500GB",1476.0),
    ("GC04","Sony Playstation 4 1TB",1805.0),
    ("GC05","Xbox Series X",2478.0),
    ("GC06","Nintendo Switch",1201.47),
    ("GC07","Nintendo Switch Lite",715.0);
...
-- game_cds -------------------------------------------------------;
    ...
    ("GA01","PS5-Fortnite: The Last Laugh",115.00),
    ("GA02","PS5-The Pathless",201.95),
    ("GA03","PS5-Control Unlimited Edition",145.00),
    ("GA04","PS5-Spider-Man: Miles Morales",145.56),
    ("GA05","PS5-Assassins Creed Valhalla",152.25),
    ("GA06","PS5-Mortal Kombat 11 Ultimate",117.95),
    ("GA07","PS5-DiRT 5 Day 1 Edition",148.00),
    ("GA08","PS5-Hitman 3",161.00),
    ("GA09","PS5-Marvel Avengers",160.00),
    ("GA10","PS5-Ghost Of Tsushima Directors Cut",305.0),
    ("GA11","PS5-Tom Clancys Rainbow Six Siege Deluxe Edition",98.41),
    ("GA12","PS5-Watch Dogs: Legion",149.0),
    ("GA13","PS5-Ranchet & Clank: Rift Apart With DLC",279.0),
    ("GA14","PS5-Just Dance 2021",131.92),
    ("GA15","PS5-WRC 9",165.03),
    ("GA16","PS5-Star Wars Jedi: Fallen Order",166.62),
    ("GA17","PS5-Maneater",78.45),
    ("GA18","PS5-Immortals Fenyx Rising",121.03),
    ("GA19","PS5-Monster Truck Championship",132),
    ("GA20","PS5-Hades",120.49),
    ("GA21","PS5-Tennis World Tour 2 Complete Edition",160.30),
    ("GA22","PS5-Ride 4",69.32),
    ("GA23","PS5-NBA 2K21",99.00),
    ("GA24","PS5-Call Of Duty Black Ops Cold War",290.0),
    ("GA25","PS5-Godfall: Deluxe Edition",364.27),
    ("GA26","PS5-Battlefield 2042",299.00),
    ("GA27","PS5-Sackboy: A Big Adventure",176.0),
    ("GA28","PS4-FIFA 21",73.35),
    ("GA29","PS4-Tom Clancys Ghost Recon Breakpoint",35.0),
    ("GA30","PS4-The Crew 2",59.19),
    ("GA31","PS4-Call Of Duty Black Ops 4",43.10),
    ("GA32","PS4-Need For Speed Rivals",60.27),
    ("GA33","PS4-Spider-Man",76.39),
    ("GA34","PS4-LEGO The Increadibles",61.99),
    ("GA35","PS4-Spider-Man: Miles Morales",159.99),
    ("GA36","PS4-Uncharted: Thiefs End",38.00),
    ("GA37","PS4-Tom Clancys The Division 2",48.41),
    ("GA38","PS4-LEGO Marvel Super Heros",65.29),
    ("GA39","PS4-Ghost Of Tsushima",115.00),
    ("GA40","PS4-Minecraft",90.38),
    ("GA41","PS4-Mortal Kombat 11",82.35),
    ("GA42","PS4-Tekken 7",56.02),
    ("GA43","PS4-Last Of Us Remastered",60.31),
    ("GA44","PS4-Destiny 2",40.21),
    ("GA45","PS4-Marvels Avengers",101.66),
    ("GA46","PS4-Little Nightmare",70.00),
    ("GA47","PS4-FIFA 20",64.00),
    ("GA48","PS4-Watch Dogs 2",57.26),
    ("GA49","PS4-LEGO Jurassic World",61),
    ("GA50","PS4-Minecraft Dungeons",97.36),
    ("GA51","XBOX-Hitman 3",210.0),
    ("GA52","XBOX-Call Of Duty: Black Ops Cold War",241.02),
    ("GA53","XBOX-FIFA 21",172.0),
    ("GA54","XBOX-Resident Evil Village",229.0),
    ("GA55","XBOX-Just Dance 2021",125.53),
    ("GA56","XBOX-Assassins Creed Valhalla",98.05),
    ("GA57","XBOX-The Dark Pictures: Little Hopes",84.78),
    ("GA58","XBOX-NBA 2K21",49.99),
    ("GA59","XBOX-Crash Bandicoot 4 Its About Time",205.88),
    ("GA60","XBOX-Cyberpunk 2077",138.0),
    ("GA61","XBOX-Outriders",137.33),
    ("GA62","Nintendo Switch-Super Smash Bros Ultimate",187.61),
    ("GA63","Nintendo Switch-The Legend Of Zelda Breath Of The Wild",198.49),
    ("GA64","Nintendo Switch-Sonic Forces",104.0),
    ("GA65","Nintendo Switch-LEGO Jurassic World",98.90),
    ("GA66","Nintendo Switch-Minecraft",104.97),
    ("GA67","Nintendo Switch-Super Mario 3D World",104.97),
    ("GA68","Nintendo Switch-Animal Crossing New Horizon",187.68),
    ("GA69","Nintendo Switch-Crash Bandicoot 4 Its About Time",186.45),
    ("GA70","Nintendo Switch-Rayman Legends: Definitive",85.37),
    ("GA71","Nintendo Switch-Mario Kart 8",187.95),
    ("GA72","Nintendo Switch-Marvel Superheroes 2",99.42),
    ("GA73","Nintendo Switch-Pokemon Sheild",187.00),
    ("GA74","Nintendo Switch-Minecraft Dungeons",98.0),
    ("GA75","Nintendo Switch-Just Dance 2021",126.0);
...
-- indoor_games ---------------------------------------------------;
    ...
    ("IG07","Rubixs Cube 3x3",41.87),
    ("IG08","Rubixs Cube 4x4",49.62),
    ("IG09","Rubixs Cube 5x5",73.04),
    ("IG10","Wilong 3x3 Magnetic Rubis Cube",159.0),
...
-- kitchen_items --------------------------------------------------;
    ...
    ("KI09","Jasmines Universe 8Pc Kitchen Knife Set",85.0),
...
-- tabs -----------------------------------------------------------;
    ...
    ("TA01","Apple iPad Pro 2021 12.9 inch 256GB 5th Generation",4439.65),
    ("TA02","Apple iPad 2020 10.2 inch 123GB 8th Generation Tab",1599.0),
    ("TA03","Apple iPad 2020 10.9 inch 64GB 4th Generation Tab",2067.97),
    ("TA04","Apple iPad Pro 2021 11 inch 3rd Generation",3361.95),
    ("TA05","Samsung Galaxy Tab S6 Lite 64GB 4GB Ram",1294.0),
    ("TA06","Samsung Galaxy Tab S7 Plus 256GB ",3149.0),
    ("TA07","Samsung Galaxy Tab S7 126GB 6GB Ram",2148.0),
    ("TA08","Samsung Galaxy Tab A7 10.4 inch 32GB",665.0),
    ("TA09","Samsung Galaxy Tab S7 FE Tab 64GB 4GB Ram",1799.0),
    ("TA10","Lenovo Tab M10 10.1 inch 16GB 2GB Ram",482.99),
    ("TA11","Lenovo Tab M8 8 inch 16GB 2GB Ram 2nd Generation",393.0),
    ("TA12","Lenovo Tab M10 Plus 10.3 inch 64GB 4GB Ram 2nd Generation",860.0),
    ("TA13","Lenovo Yoga Smart Tab 10.1 inch 64GB 4GB Ram",1098.99),
    ("TA14","Lenovo Yoga Smart Tab 10.1 inch 32GB 3GB Ram",849.0),
    ("TA15","Aeezo Kids Tab 7 inch 32GB 2GB Ram",288.99),
    ("TA16","Huawei Matepad T10 10.1 inch 32GB Tab",648.99),
    ("TA17","Huawei Matepad T10 9.7 inch 16GB 2GB Ram Tab",499.),
    ("TA18","Samsung Galaxy Tab A7 Lite 32GB 3GB Ram Tab",611.15),
    ("TA19","Apple iPad Mini 2019 7.9 inch 5th Generation Tab",2729.0),
    ("TA20","Discover Note 8 Plus 10.1 inch 64GB 4GB Tab",288.0);
